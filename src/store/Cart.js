...
export default function CartReducer (state = intialState, action) {
    switch(action.type){
        ...
        case 'REMOVE_FROM_CART' :
            ...
            let productExists2 = newCartItems2.find(cartItem => cartItem.id === product2.id);
            if(productExists2.quantity === 1){
                newCartItems2 = newCartItems2.filter(cartItem => cartItem.id !== product2.id);
...
// console.log(CartReducer(intialState, addToCart({id: 1, name: 'laptop', price: '$1000', description: 'Laptop for students', image: 'https://cdn.mos.cms.futurecdn.net/6t8Zh249QiFmVnkQdCCtHK.jpg'})));